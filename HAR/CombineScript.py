...
train_path = "./HAR/human+activity+recognition+using+smartphones/UCI HAR Dataset/UCI HAR Dataset/train"
test_path = "./HAR/human+activity+recognition+using+smartphones/UCI HAR Dataset/UCI HAR Dataset/test"
